<template>
    <div @click="onPagerClick" class="table-pager">
        ...
        <el-button class="arrow-right" type="button" :disabled="isMax"><i class="el-icon-arrow-right"></i></el-button>
        <el-button class="d-arrow-right" type="button" :disabled="isMax"><i class="el-icon-d-arrow-right"></i></el-button>
