            ...
            <div class="card-content">
                <div class="params-msg">
                    <div class="row-params-status">
                        <div class="left-text">
                            <img
                                src="../../../assets/img/loudianbaohu.png"
                                alt=""
                            />
                        ...
                        <div class="right-text">
                            ...
                            <div
                                class="off-gap"
                                v-if="leakage_protection_status == 0"
                            ></div>
                            <p
                                class="gap-comp"
                                v-if="leakage_protection_status == 0"
                            ...
                            <div
                                class="on-gap"
                                v-if="leakage_protection_status == 1"
                            ></div>
                            <p
                                class="gap-comp"
                                v-if="leakage_protection_status == 1"
                    ...
                    <div class="row-params-status">
                        <div class="left-text">
                            <img
                                src="../../../assets/img/edingloudian.png"
                                alt=""
                            />
        ...
        async getDevParams(params, click) {
            if (params) {
                ...
                if (res.data.code != 0) {
                    ...
                    (this.leakage_protection_status =
                        data.leakage_protection_status),
